...
public abstract class AbstractPatient implements Comparable<AbstractPatient> {
	...
	/**
	 * Patients with medium TreatmentPriority have a injuryRating
	 */
	...
	public AbstractPatient(String patientName, LocalTime patientArrivalTime, int injuryRating) {
		name = patientName;
		arrivalTime = patientArrivalTime;
